...
public sealed class ZteDeviceAdapter : IOntDeviceAdapter
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        var capabilities = new DeviceCapabilities(
            ...
            Notes:
            [
                "Fase 0.1.8-lab: leitura automática homologada de Device, PON, WAN Status e WAN Config da F6201B V9.3.10P8N1, sem escrita. Mapeamento WAN/PPPoE bloqueado antes da rede.",
