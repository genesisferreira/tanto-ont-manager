...
A Fase 1 é **somente leitura**. A versão `0.1.4.2-lab` autentica a F6201B mesmo quando a firmware ainda não foi lida e só encerra a sessão se uma versão real diferente for confirmada. Não altera WAN, PPPoE, VLAN, firmware nem a placa Ethernet.
