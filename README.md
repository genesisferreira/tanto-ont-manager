...
A Fase 1 é **somente leitura**. A versão `0.1.6.2-lab` observa passivamente os GETs dinâmicos da interface web da F6201B. Não altera WAN, PPPoE, VLAN, firmware nem a placa Ethernet.
