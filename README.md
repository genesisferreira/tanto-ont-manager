...
A Fase 1 é **somente leitura**. A versão `0.1.3.1-lab` autentica a F6201B, lê Device/PON/WAN por GET evidenciado e encerra a sessão com logout oficial. O hotfix corrige a classificação falsa de sessão expirada após o login. Não altera WAN, PPPoE, VLAN, firmware nem a placa Ethernet.
