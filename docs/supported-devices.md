...
|---|---|---|---|
| ZTE | ZXHN F6201B | Detecção pública + leitura automática autenticada 0.1.7.2-lab | HTTPS `192.168.100.1`; GET homologados menuView+menuData Device/PON/WAN; aliases XML lua Device/PON; logout oficial no clique |
